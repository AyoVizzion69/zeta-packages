return {
  ...
  deps    = { "wayland", "wayland-protocols", "xkbcommon", "xorgproto", "libxcb", "libXau", "libXdmcp", "pixman", "libdrm", "libepoxy", "libglvnd", "mesa", "xtrans", "libxcvt", "libxshmfence", "libXfont2", "libfontenc", "libpciaccess", "xkbcomp", "xkeyboard-config" },
  archive = { strip = 1 },
  test    = function(p)
