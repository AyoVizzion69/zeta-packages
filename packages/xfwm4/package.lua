return {
  ...
  deps    = { "libxfce4ui", "libxfce4util", "xfconf", "gtk3", "libX11", "libXcomposite", "libXdamage", "libXext", "libXfixes", "libXinerama", "libXpresent", "libXrandr", "libXrender", "libXres", "libSM", "libICE", "libepoxy", "harfbuzz", "cairo", "pango" },
  archive = { strip = 1 },
  test    = function(p)
