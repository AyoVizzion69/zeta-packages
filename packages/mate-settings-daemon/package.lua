return {
  ...
  deps    = { "glib", "gtk3", "dconf", "mate-desktop", "libnotify", "libcanberra", "libmatekbd", "libxklavier", "libX11", "libXi", "libXrandr", "libXfixes", "libXtst", "libXext", "fontconfig", "polkit", "gsettings-desktop-schemas", "libSM", "libICE" },
  archive = { strip = 1 },
  test    = function(p)
