return {
  ...
  deps    = { "wlroots", "wayland", "wayland-protocols", "libdrm", "xkbcommon", "pixman", "libxml2", "glib", "cairo", "pango", "libpng", "libinput", "librsvg", "libxcb", "xcb-util", "xcb-util-wm", "xcb-util-keysyms", "xcb-util-cursor", "xcb-util-image", "xcb-util-renderutil" },
  archive = { strip = 1 },
  test    = function(p)
