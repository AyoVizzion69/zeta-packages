return {
  ...
  deps    = { "liblxqt", "lxqt-session", "lxqt-panel", "lxqt-runner", "lxqt-notificationd", "pcmanfm-qt", "lxqt-about", "lxqt-globalkeys", "lxqt-config", "lxqt-policykit", "lxqt-powermanagement", "lxqt-qtplugin", "md4c", "double-conversion", "libb2", "xkbcommon", "expat" },
  archive = { strip = 1 },
  test    = function(p)
