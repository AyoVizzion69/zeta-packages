return {
  ...
  deps    = { "liblxqt", "lxqt-session", "lxqt-panel", "lxqt-runner", "lxqt-notificationd", "pcmanfm-qt", "lxqt-about", "lxqt-globalkeys", "lxqt-config", "lxqt-policykit", "lxqt-powermanagement", "lxqt-qtplugin" },
  archive = { strip = 1 },
  test    = function(p)
