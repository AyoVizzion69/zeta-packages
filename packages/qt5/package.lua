return {
  ...
  deps    = { "dbus", "double-conversion", "fontconfig", "freetype", "glib", "gtk3", "harfbuzz", "icu", "libX11", "libXcomposite", "libdrm", "libglvnd", "libinput", "libmtdev", "libpng", "libxcb", "libz", "md4c", "mesa", "pango", "pcre2", "tslib", "wayland", "xcb-util-image", "xcb-util-keysyms", "xcb-util-renderutil", "xcb-util-wm", "xkbcommon", "zstd" },
  archive = { strip = 1 },
  test    = function(p)
