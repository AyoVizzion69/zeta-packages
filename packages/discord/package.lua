return {
  ...
  deps    = { "alsa-lib", "at-spi2-core", "cairo", "expat", "glib", "gtk3", "libX11", "libXcomposite", "libXcursor", "libXdamage", "libXext", "libXfixes", "libXi", "libXrandr", "libXrender", "libxss", "libXtst", "libdrm", "libxcb", "mesa", "nss", "pango", "pulseaudio", "wayland", "xkbcommon" },
  archive = { strip = 1 },
  test    = function(p)
