return {
  ...
  deps    = { "dbus", "expat", "fontconfig", "freetype", "glib", "libjpeg-turbo", "libpng", "libX11", "libxcb", "libz", "xcb-util-cursor", "xcb-util-image", "xcb-util-keysyms", "xcb-util-renderutil", "xcb-util-wm", "xkbcommon" },
  archive = { strip = 1 },
  test    = function(p)
