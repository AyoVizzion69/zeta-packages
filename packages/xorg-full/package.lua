return {
  ...
  deps    = { "xorg-server", "xf86-input-libinput", "xinit", "xorgproto", "xcb-proto", "xtrans", "libX11", "libXau", "libXaw", "libXcomposite", "libXcursor", "libXdamage", "libXdmcp", "libXext", "libXfixes", "libXfont2", "libXft", "libXi", "libXinerama", "libXkbfile", "libXmu", "libXpm", "libXpresent", "libXrandr", "libXrender", "libXres", "libXt", "libXtst", "libXxf86vm", "libICE", "libSM", "libxss", "libxshmfence", "libxcvt", "libfontenc", "libpciaccess", "libxcb", "xcb-util", "xcb-util-cursor", "xcb-util-image", "xcb-util-keysyms", "xcb-util-renderutil", "xcb-util-wm", "libinput", "libevdev", "xkbcommon", "xkbcomp", "xkeyboard-config", "libxklavier", "mesa", "libglvnd", "libepoxy", "pixman", "libdrm", "fontconfig", "freetype", "xauth", "xdpyinfo", "xgamma", "xmessage", "xmodmap", "xprop", "xrandr", "xrdb", "xset", "setxkbmap", "xterm" },
  archive = { strip = 1 },
  test    = function(p)
