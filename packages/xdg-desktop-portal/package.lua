return {
  ...
  url     = "https://github.com/gretagen/zeta-packages/packages/xdg-desktop-portal/xdg-desktop-portal-1.22.1.tar.gz",
  sha256  = "d8518d9d3ff9d0cda68f1dc051085da01ced54bd8b3382940d3aa0676fb560fb",
  deps    = { "gdk-pixbuf", "pipewire", "libfuse3", "libjson-glib" },
  archive = { strip = 1 },
  test    = function(p)
