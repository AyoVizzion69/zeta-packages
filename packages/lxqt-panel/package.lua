return {
  ...
  deps    = { "kwindowsystem", "layer-shell-qt", "libXtst", "libdbusmenu-lxqt", "liblxqt", "libqtxdg", "lxqt-globalkeys", "qtbase", "qtsvg", "qtwayland", "solid", "wayland", "xcb-util", "xcb-util-image", "xkbcommon" },
  archive = { strip = 1 },
  test    = function(p)
